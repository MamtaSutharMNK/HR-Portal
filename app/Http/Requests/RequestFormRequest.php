...
class RequestFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        'manager_email_l1' => 'required|email',
        'hr_email_l1' => 'required|email',
        'manager_email_l2' => 'nullable|email',
        'hr_email_l2' => 'nullable|email',
        'manager_email_l3' => 'nullable|email',
        'hr_email_l3' => 'nullable|email',
